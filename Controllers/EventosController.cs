...
namespace Web_Application_Desafio_Pulse_It.Controllers
{
    public class EventosController : Controller
    {
        ...
        public EventosController(DesafioContext context)
        {
            _context = context;
        }
        ...
        {
            var desafioContext = _context.Eventos.Include(e => e.Usuario);
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Descripcion,FechaEvento,UsuarioId")] Evento evento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Descripcion,FechaEvento,UsuarioId")] Evento evento)
        {
            if (id != evento.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DesafioContext.Eventos'  is null.");
            }
            var evento = await _context.Eventos.FindAsync(id);
            if (evento != null)
            {
